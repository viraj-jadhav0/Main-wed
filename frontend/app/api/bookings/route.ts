...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('Frontend API: Create booking request body:', body)
    ...
    console.error('Frontend API: Error creating booking:', error)
...
export async function GET() {
  try {
    console.log('Frontend API: Fetching bookings from:', API_URL)
    ...
    console.error('Frontend API: Error fetching bookings:', error)
    const errorResponse = NextResponse.json(
