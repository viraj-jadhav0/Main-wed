...
export async function GET() {
  try {
    console.log('Frontend API: Fetching services from:', API_URL)
    ...
    console.error('Frontend API: Error fetching services:', error)
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('Frontend API: Create service request body:', body)
    ...
    console.error('Frontend API: Error creating service:', error)
    const errorResponse = NextResponse.json(
