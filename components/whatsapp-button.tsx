...
const WHATSAPP_NUMBER = "919356273613"
const WHATSAPP_URL = `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(
  "Namaste! I would like to book a pooja with GurujiforPooja.",
)}`
...
export function WhatsAppButton() {
  return (
    <a
      ...
      className="group fixed bottom-5 right-5 z-50 flex size-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-black/20 transition-transform duration-300 hover:scale-110 active:scale-95 sm:bottom-6 sm:right-6"
    >
